...
placeholders=(
    ...
    "PROJECT_ID_DEV:GCP development Project ID"
    "PROJECT_ID_PROD:GCP production Project ID"
    "SERVICE_ACCOUNT_DEV:Service account in GCP development Project"
    "SERVICE_ACCOUNT_PROD:Service account in GCP production Project"
